...
class TabletRegisterLayout extends StatefulWidget {
  const TabletRegisterLayout({super.key});

  @override
  State<TabletRegisterLayout> createState() => _TabletRegisterLayoutState();
}

class _TabletRegisterLayoutState extends State<TabletRegisterLayout> {
